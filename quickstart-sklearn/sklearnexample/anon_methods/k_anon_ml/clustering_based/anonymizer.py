...
from clustering_based.clustering_based_k_anon import clustering_based_k_anon
...
def get_result_one(att_trees, data, k, path, qi_index, SA_index, type_alg, csv_file=''):
